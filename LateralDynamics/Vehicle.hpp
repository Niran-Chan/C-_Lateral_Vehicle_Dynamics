...
public:
    double δfmax; ///<Maximum Steering Angle of Front Tire w.r.t Longitudinal Axis of Vehicle (rad)
    double δrmax; ///<Angle of Rear Tire w.r.t Longitudinal Axis of Vehicle (rad)
